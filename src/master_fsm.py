...
class MasterFSM(FSM, DirectObject):
    ...
    def enterChargen(self):
        ...
        ability_label, race_list, alignment_list, button_row = self.ui.chargen_frame()
        chargen_screen = chargen.Chargen(self.base_window, ability_label,race_list, alignment_list, button_row)
