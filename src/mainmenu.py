...
class MainMenu(DirectObject):
    ...
    def display_main_menu(self):
        ...
        self.button_frame.addItem(add_button, 0, 1)
        self.button_frame.addItem(remove_button, 1, 1)
        self.button_frame.addItem(load_button, 2, 1)
        self.button_frame.addItem(save_button, 3, 1)
        self.button_frame.addItem(quit_button, 4, 1)
